package ru.mirea.yakovlev.M.web.http;
...
public class PkmnHttpClient {
    ...
    public JsonNode getPokemonCard(String name, String number,String series,int hp) throws IOException {
        String requestQuery = "name:\"" + name + "\" number:\"" + number+"\" set.series:\""+series+"\" hp:\""+hp+"\"";
